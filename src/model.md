...
By **model** we mean a mathematical and/or computational description
of some aspects of a system of interest that we can explore in order
to gain insight into the behaviour of the real system.

A **mathematical model** consists of one or more equations expressing
